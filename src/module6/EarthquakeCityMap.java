	...
	private void checkCitiesForClick()
	{
		...
		for (Marker marker : cityMarkers) {
			if (!marker.isHidden() && marker.isInside(map, mouseX, mouseY)) {
				...
				System.out.println("Clicked city: " + marker.getStringProperty("name"));//Luyi: Debug purpose. Show the clikced city name.
				...
				for (Marker mhide : quakeMarkers) {
					...
					if (quakeMarker.getDistanceTo(marker.getLocation()) 
						...
						System.out.println(quakeMarker.getTitle() + " ,Threat cicle: " + quakeMarker.threatCircle());//Luyi: Debug purpose. Show the threat circle and average magnitude.
