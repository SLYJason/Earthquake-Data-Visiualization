...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {
		...
		fill(244, 240, 12);
		ellipse(60, 185, 13, 13);
		fill(0,0,0);
		textSize(12);
		text("Shallow", 70, 183);

		fill(11, 122, 239);
		ellipse(60, 205, 13, 13);
		fill(0,0,0);
		textSize(12);
		text("Intermediate", 70, 203);

		fill(255,0,0);
		ellipse(60, 225, 13, 13);
		fill(0,0,0);
		textSize(12);
		text("Deep", 70, 223);
		...
		for(Marker countryMarker:countryMarkers){
			for(Marker quakeMarker:quakeMarkers){
				if(quakeMarker instanceof LandQuakeMarker){
					if(((LandQuakeMarker)quakeMarker).getCountry() == countryMarker.getProperty("name")){
						landcount++;
						totalcount++;
					}
				}
